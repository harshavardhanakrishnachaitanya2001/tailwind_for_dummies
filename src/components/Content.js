        ...
        <>
            <div className='space-y-3'>
                ...
                <div>
                    ...
                    <p>There won't be any changes in these steps to setup tailwindcss for the most part, but based on the framework you want to use tailwind for, there will be very slight changes. <a href='https://tailwindcss.com/docs/installation/framework-guides' target="_blank" className=' hover:underline text-blue-500 transition'>Click here to know the ways of adding tailwind to different frameworks</a></p>
                    <p>I am telling the setup of tailwind, for websites made using create-react-app here </p>
                </div>
            </div>
        </>
    )
